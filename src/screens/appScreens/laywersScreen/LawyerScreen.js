...
import {
  ...
  submit,
  setSpecialization,
} from "src/redux/actions/lawyerAction";
...
import ImagePickerr from "src/components/ImagePickerr";
  ...
  componentDidMount() {
    ...
    firestore()
      ...
      .then((user) => {
        ...
        this.props.setName(user.data().name);
        this.props.setLicense(user.data().license);
        this.props.setNumber(user.data().number);
        this.props.setAddress(user.data().address);
        this.props.setCity(user.data().city);
        this.props.setEducation(user.data().education);
        this.props.setExperience(user.data().experience);
        this.props.setGender(user.data().gender);
        this.props.setSpecialization(user.data().specialization);
      });
